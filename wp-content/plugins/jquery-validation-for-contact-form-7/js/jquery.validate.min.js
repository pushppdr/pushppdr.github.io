...
jQuery.validator.addMethod(
  ...
  function (d, e) {
    ...
    var t,
      ...
      Z = 0,
      n = !1;
    if (((d = d.replace(/\D/g, "")), d.length < 13 || d.length > 19)) return !1;
  ...
  jQuery.validator.addMethod(
    ...
    function (d, e) {
      ...
      if (
        ...
        (n = a[t]),
        "undefined" != typeof n &&
          ((i = new RegExp("^[A-Z]{2}\\d{2}" + n + "$", "")), !i.test(s)))
      )
        return !1;
      for (
        A = s.substring(4, s.length) + s.substring(0, 4), l = 0;
        l < A.length;
        l++
      )
        (r = A.charAt(l)),
          "0" !== r && (h = !1),
          h || (u += "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ".indexOf(r));
      for (o = 0; o < u.length; o++)
        (Z = u.charAt(o)), (f = "" + c + Z), (c = f % 97);
      return 1 === c;
    },
